 ...
 * 2. 几个方法的返回参数类型：java.util.Scanner -> com.shengyu.oj.execute.HackScanner
 *
...
public final class HackScanner implements Iterator<String>, Closeable {
     ...
     * @return this scanner
     */
    public com.shengyu.oj.execute.HackScanner useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public com.shengyu.oj.execute.HackScanner useDelimiter(String pattern) {
     ...
     * @return this scanner
     */
    public com.shengyu.oj.execute.HackScanner useLocale(Locale locale) {
     ...
     */
    public com.shengyu.oj.execute.HackScanner useRadix(int radix) {
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public com.shengyu.oj.execute.HackScanner skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public com.shengyu.oj.execute.HackScanner skip(String pattern) {
     ...
     * @since 1.6
     */
    public com.shengyu.oj.execute.HackScanner reset() {
